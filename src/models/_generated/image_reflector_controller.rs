...
// kopium command: kopium --filename /tmp/tmp.gjNTDPQTAF/doc1.yaml --derive Default --derive PartialEq --docs --smart-derive-elision
...
// WARNING: generated by kopium - manual changes will be overwritten
// kopium command: kopium --filename /tmp/tmp.gjNTDPQTAF/doc2.yaml --derive Default --derive PartialEq --docs --smart-derive-elision
// kopium version: 0.23.0
