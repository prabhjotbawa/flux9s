//! Auto-generated models for flux-operator-fluxinstances
//! Generated from: flux-operator-fluxinstances.crds.yaml
//! DO NOT EDIT - This file is auto-generated by kopium
#![allow(clippy::all)]

// WARNING: generated by kopium - manual changes will be overwritten
// kopium command: kopium --filename /tmp/tmp.NjpimeHbTx/doc1.yaml --derive Default --derive PartialEq --docs --smart-derive-elision
...
pub struct FluxInstanceCluster {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "multitenantWorkloadIdentity"
    )]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "objectLevelWorkloadIdentity"
    )]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "tenantDefaultDecryptionServiceAccount"
    )]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "tenantDefaultKubeConfigServiceAccount"
    )]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "tenantDefaultServiceAccount"
    )]
